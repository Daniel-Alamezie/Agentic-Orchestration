...
public sealed class MagenticPatternRunner : IPatternRunner
{
    ...
    public PatternInfo Info => new(
        ...
        ScenarioDescription: "A serious incident with unknown scope is handled by a Manager Agent that builds a dynamic task plan. The plan adapts as each specialist reports back, potentially adding new investigative steps based on what they find.",
        DefaultPrompt:       "URGENT: We have a major incident at our Distribution Centre. An ammonia leak has been detected in the refrigeration plant room. Six colleagues have been evacuated, two are showing symptoms of respiratory distress. The plant room also contains the server room for our warehouse management system, and the main electrical substation for the building. Emergency services have been called but have not yet arrived.",
